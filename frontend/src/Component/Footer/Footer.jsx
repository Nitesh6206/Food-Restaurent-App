      ...
      <div className="container py-5">
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            <h4 className="section-title ff-secondary text-start text-orange fw-normal mb-4">Company</h4>
            <a className="btn btn-link text-white" href="#">About Us</a>
            <a className="btn btn-link text-white" href="#">Contact Us</a>
            <a className="btn btn-link text-white" href="#">Reservation</a>
            <a className="btn btn-link text-white" href="#">Privacy Policy</a>
            <a className="btn btn-link text-white" href="#">Terms & Condition</a>
          </div>
          <div className="col-lg-3 col-md-6">
            <h4 className="section-title ff-secondary text-start text-orange fw-normal mb-4">Contact</h4>
          ...
          <div className="col-lg-3 col-md-6">
            <h4 className="section-title ff-secondary text-start text-orange fw-normal mb-4">Opening</h4>
          ...
          <div className="col-lg-3 col-md-6">
            <h4 className="section-title ff-secondary text-start text-orange fw-normal mb-4">Newsletter</h4>
        ...
        <div className="copyright">
          <div className="row">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
              ...
              <br />
              Designed By <a className="border-bottom" href="/">Nitesh Kumar</a>
              <br />
            </div>
